...
describe.skip('cleanDir', () => {
    it.skip('should rm -rf Dir', () => {
        cleanDir(DIR_OUT_ABS)
    })
});

describe.skip('readCookiesFile', () => {
